...
const Form = ({ type, prompt, setPrompt, submitting, handleCreatePrompt }) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      >
        ...
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">
            Tag <span className="font-normal">(#product, #webdevelopemnt)</span>
          </span>
          <input
            value={prompt.tag}
        ...
        <div className="flex-end mx3 mb-5 gap-4">
